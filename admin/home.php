        ...
        <div class="container">
            ...
            <div class="collapse navbar-collapse mt-2" id="navbarNavAltMarkup">
                <div class="navbar-nav me-auto">
                    <a href="home.php" class="nav-link">Home</a> <!-- Warna merah -->
                    <a href="album.php" class="nav-link">Album</a> <!-- Warna merah -->
                    <a href="foto.php" class="nav-link">Foto</a> <!-- Warna merah -->
                </div>
...
<div class="container mt-3">
    ...
    <a href="home.php?albumid=<?php echo $row['albumid'] ?>" class="btn btn-secondary">
