                                            ...
                                            <div class="m-2">
                                                <div class="overflow-auto">
                                                    <div class="sticky-top">
                                                        ...
                                                        <span class="badge bg-danger" style="color: #fff;"><?php echo $data['namalengkap'] ?></span>
                                                        <span class="badge bg-danger" style="color: #fff;"><?php echo $data['tanggalungguh'] ?></span>
                                                        <span class="badge bg-success" style="color: #fff;"><?php echo $data['namaalbum'] ?></span>
                                                    </div>
                                                    <hr>
                                                    <p align="black"style="color: black;">
                                                    ...
                                                    ?>
                                                        <p align="black">
                                                            <strong style="color: black;"><?php echo $row['namalengkap'] ?></strong>
                                                            <span style="color: black;"><?php echo $row['isikomentar'] ?></span>
                                                        </p>
                                                    <?php } ?>
                                                    <hr>
